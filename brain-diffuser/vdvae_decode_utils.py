...
def get_ref_latent(sub):
    batch_size = 1
    image_path = os.path.join(ROOT_PATH, 'data/processed_data/subj{:02d}/nsd_test_stim_sub{}.npy'.format(sub,sub))
